...
import usuariosRoutes from "@/modules/usuarios/usuarios/routes/router.ts";
...
import honorariosRoutes from "@/modules/honorarios/routes/router.ts";
...
app.route("/usuarios/usuarios", usuariosRoutes);
